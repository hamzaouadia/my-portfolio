...
const paths = [
    ...
    { name: 'gmail', path: '/my-portfolio/assets/gmail-logo.svg', url: 'mailto:your-email@gmail.com' },
    { name: 'instagram', path: '/my-portfolio/assets/instagram-logo.svg', url: 'https://instagram.com/your-profile' },
    { name: 'linkedin', path: '/my-portfolio/assets/linkedin-logo.svg', url: 'https://linkedin.com/in/your-profile' },
];
